...
class Server:
    ...
    """
    def __init__(self, vad_pipeline, asr_pipeline, ltm_pipeline, host='localhost', port=8765, sampling_rate=16000, samples_width=2):
        self.vad_pipeline = vad_pipeline
        self.asr_pipeline = asr_pipeline
        self.ltm_pipeline = ltm_pipeline
        self.host = host
        self.port = port
    ...
    async def handle_audio(self, client, websocket):
        while True:
            ...
            client.process_audio(websocket, self.vad_pipeline, self.asr_pipeline, self.ltm_pipeline)
